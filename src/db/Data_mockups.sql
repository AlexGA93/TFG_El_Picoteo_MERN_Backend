...
(1, 'Juan', 'Perez Gomez', 'juan.perez@example.com', 'hashed_pass_1', 'admin'),
(2, 'Maria', 'Lopez Sanchez', 'maria.lopez@example.com', 'hashed_pass_2', 'employee'),
(3, 'Carlos', 'Ramirez Diaz', 'carlos.ramirez@example.com', 'hashed_pass_3', 'employee');
