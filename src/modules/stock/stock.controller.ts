...
export const create = asyncHandler(async (req: Request, res: Response) => {
  ...
  const { id, nombre_producto, precio_producto, tiempo_produccion_min, dificultad, url } = req.body;
...
export const update = asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  const { nombre_producto, precio_producto, tiempo_produccion_min, dificultad, url } = req.body;
